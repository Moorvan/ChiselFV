...
class Counter(max_val: Int) extends Module with Formal {
  ...
  assertAt(1.U, count === 1.U) // after 1 cycle, count is 1
  assertAt(2.U, count === 2.U) // after 2 cycles, count is 2
  assertAt(3.U, count === 3.U) // after 3 cycles, count is 3
  assertAt(4.U, count === 4.U) // after 4 cycles, count is 4
